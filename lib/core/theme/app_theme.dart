...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF2F94F4),
      surfaceTint: Color(0xFF2F94F4),
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFF7fe4ff),
      onPrimaryContainer: Color(0xFF076ccc),
      secondary: Color(0xFF95A1C6),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFe5f1ff),
      onSecondaryContainer: Color.fromARGB(255, 255, 255, 255),
      tertiary: Color(0xFF3095F8),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF80e5ff),
      onTertiaryContainer: Color(0xFF086dd0),
      ...
      inversePrimary: Color(0xFF1b80e0),
      primaryFixed: Color(0xFF7fe4ff),
      onPrimaryFixed: Color(0xFF0058b8),
      primaryFixedDim: Color(0xFF6bd0ff),
      onPrimaryFixedVariant: Color(0xFF1b80e0),
      secondaryFixed: Color(0xFFe5f1ff),
      onSecondaryFixed: Color(0xFF59658a),
      secondaryFixedDim: Color(0xFFd1ddff),
      onSecondaryFixedVariant: Color(0xFF818db2),
      tertiaryFixed: Color(0xFF80e5ff),
      onTertiaryFixed: Color(0xFF0059bc),
      tertiaryFixedDim: Color(0xFF6cd1ff),
      onTertiaryFixedVariant: Color(0xFF1c81e4),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF1b80e0),
      surfaceTint: Color(0xFF1b80e0),
      onPrimary: Color(0xFFFAF9F6),
      primaryContainer: Color(0xFF0058b8),
      onPrimaryContainer: Color(0xFF7fe4ff),
      secondary: Color(0xFF818db2),
      onSecondary: Color(0xFF455176),
      secondaryContainer: Color(0xFF59658a),
      onSecondaryContainer: Color(0xFFe5f1ff),
      tertiary: Color(0xFF1c81e4),
      onTertiary: Color(0xFF0045a8),
      tertiaryContainer: Color(0xFF0059bc),
      onTertiaryContainer: Color(0xFF80e5ff),
      ...
      onSurfaceVariant: Color.fromARGB(255, 27, 88, 243),
      ...
      inversePrimary: Color(0xFF2F94F4),
      primaryFixed: Color(0xFF7fe4ff),
      onPrimaryFixed: Color(0xFF0058b8),
      primaryFixedDim: Color(0xFF6bd0ff),
      onPrimaryFixedVariant: Color(0xFF1b80e0),
      ...
      onTertiaryFixed: Color(0xFF0059bc),
      tertiaryFixedDim: Color(0xFF6cd1ff),
      onTertiaryFixedVariant: Color(0xFF1fffff),
